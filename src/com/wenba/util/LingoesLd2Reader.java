...
public class LingoesLd2Reader {
  ...
  public static void main(final String[] args) throws IOException {
    ...
    //final String ld2File = "C:\\Users\\PC\\Downloads\\ViconEnglishDictionary.ld2";
    //InputStream in = ClassLoader.getSystemResourceAsStream("/ViconEnglishDictionary.ld2");
    final String ld2File = new LingoesLd2Reader().getClass().getResource("ViconEnglishDictionary.ld2").getPath();
